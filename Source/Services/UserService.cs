...
)
{
    ...
    public async Task<ServiceResponse<List<UserDto>>> GetAllUsers()
    {
        try
        {
            List<UserDto> users = await appContext
    ...
    public async Task<ServiceResponse<UserDto>> RegisterUser(RegisterUserDto registerUserDto)
    {
        ...
        try
        {
            ...
            var userByEmail = await appContext.Users.AnyAsync(u =>
            ...
            var userByPhone = await appContext.Users.AnyAsync(u =>
            ...
            else if (registerUserDto.Role == Role.Doctor)
            {
                ...
                {
                    logger.LogError(
                        "Error creating specialities, returned null from speciality service."
                    );
